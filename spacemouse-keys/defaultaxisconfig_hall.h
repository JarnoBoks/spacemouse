#ifndef DEFAULTAXISCONFIG_HALL_H
#define DEFAULTAXISCONFIG_HALL_H

// --------------------- AXIS DEFAULTS -------------------------

// Default axis configuration for spacemouse with HALL sensors.
// ============================================================
// This file contains the default configuration settings for the HALL sensors.
...
#endif // DEFAULTAXISCONFIG_HALL_H