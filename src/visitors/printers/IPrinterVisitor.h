...
public:
    ...
    virtual void visit(KnobAxis &axis) = 0;
    virtual void visit(KnobAxisConfig &config) = 0;
    virtual void visit(KinematicsConfig &config) = 0;
    virtual void visit(KinematicsMVConfig &config) {};
    virtual void visit(AxisBase &config) {};
    virtual void visit(MotionVectorConfig &config) {};
    // Add more as needed
};
