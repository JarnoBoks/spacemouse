#include "ParamSensorAxisKeysInformationExclusive.hpp"
 ...
 */
DebugParamSensorAxisKeysInformationExclusive::~DebugParamSensorAxisKeysInformationExclusive() {
 ...
 */
void DebugParamSensorAxisKeysInformationExclusive::apply() {

    m_SensorObserver = new DebugOutputSensorsCentered(false); // Print separator after output, no newline
    m_AxisObserver = new DebugOutputAxesFinal(false);         // Print separator after output, no newline
