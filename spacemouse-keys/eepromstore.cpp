 ...
 */
bool EEPROMStore::loadConfig(AxisConfig &config, int axisnumber) {
    if (isFirstRun()) {
    ...
    return true; // Return true while the configuration was loaded successfully
}
 ...
 */
void EEPROMStore::saveConfig(AxisConfig &config, int axisnumber) {
    EEAxisConfig eeConfig;
 ...
 * @return true if the configuration was loaded successfully, false otherwise.
 */
bool EEPROMStore::loadConfig(SensorConfig &config, int sensornumber) {
    if (isFirstRun()) {
        return false; // EEPROM is not initialized, return false
    }
...
void EEPROMStore::saveConfig(SensorConfig &config, int sensornumber) {
    EESensorConfig eeConfig;
