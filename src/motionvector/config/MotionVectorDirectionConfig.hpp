...
class MotionVectorDirectionConfig {
private:
...
public:
    MotionVectorDirectionConfig() = default; // Default constructor
    MotionVectorDirectionConfig(float sensitivity, uint8_t gate, ModFunc_t modFuncType);
    ~MotionVectorDirectionConfig() = default;
