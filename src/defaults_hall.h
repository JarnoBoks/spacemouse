 ...
 *
 * This file contains the default configuration settings for the HALL Effect sensor hardware.
 * The values are used to set the default configuration for the HALL Effect axes as well as the sensors for the spacemouse.
