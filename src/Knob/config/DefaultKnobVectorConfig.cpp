...
KnobVectorConfig DefaultKnobVectorConfig::getDefaultConfig(MotionVector_t type) {
    ...
    case MotionVector_t::TRANSX:
        return KnobVectorConfig(S_TP(DEF_SENS_TX_POS), S_TP(DEF_SENS_TX_NEG), G_TP(DEF_GATE_TX_POS), G_TP(DEF_GATE_TX_NEG), M_TP(DEF_MF_TX_POS), M_TP(DEF_MF_TX_NEG), DEF_INVERT_TX);
    case MotionVector_t::TRANSY:
        return KnobVectorConfig(S_TP(DEF_SENS_TY_POS), S_TP(DEF_SENS_TY_NEG), G_TP(DEF_GATE_TY_POS), G_TP(DEF_GATE_TY_NEG), M_TP(DEF_MF_TY_POS), M_TP(DEF_MF_TY_NEG), DEF_INVERT_TY);
    case MotionVector_t::TRANSZ:
        return KnobVectorConfig(S_TP(DEF_SENS_TZ_POS), S_TP(DEF_SENS_TZ_NEG), G_TP(DEF_GATE_TZ_POS), G_TP(DEF_GATE_TZ_NEG), M_TP(DEF_MF_TZ_POS), M_TP(DEF_MF_TZ_NEG), DEF_INVERT_TZ);
    case MotionVector_t::ROTX:
        return KnobVectorConfig(S_TP(DEF_SENS_RX_POS), S_TP(DEF_SENS_RX_NEG), G_TP(DEF_GATE_RX_POS), G_TP(DEF_GATE_RX_NEG), M_TP(DEF_MF_RX_POS), M_TP(DEF_MF_RX_NEG), DEF_INVERT_RX);
    case MotionVector_t::ROTY:
        return KnobVectorConfig(S_TP(DEF_SENS_RY_POS), S_TP(DEF_SENS_RY_NEG), G_TP(DEF_GATE_RY_POS), G_TP(DEF_GATE_RY_NEG), M_TP(DEF_MF_RY_POS), M_TP(DEF_MF_RY_NEG), DEF_INVERT_RY);
    case MotionVector_t::ROTZ:
        return KnobVectorConfig(S_TP(DEF_SENS_RZ_POS), S_TP(DEF_SENS_RZ_NEG), G_TP(DEF_GATE_RZ_POS), G_TP(DEF_GATE_RZ_NEG), M_TP(DEF_MF_RZ_POS), M_TP(DEF_MF_RZ_NEG), DEF_INVERT_RZ);
    default:
        return KnobVectorConfig(); // Return an empty KnobVectorConfig if the type is not recognized
    }
}
