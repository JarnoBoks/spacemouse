...
#include <base/collection/AxisCollectionBase.hpp> // Base class for the collection of motion vectors
 ...
 */
class KinematicsAxisCollection : public AxisCollectionBase, public Observable, public VisitableBase {
private:
...
public:
    ...
    KinematicsAxisCollection()
        : AxisCollectionBase(c_KIN_MAX_MOTIONVECTORS),
