...
#define MAX_INPUT_SIZE 32 // Maximum size of the input buffer
 ...
 */
void CommandHandler::handleInput(char input[], const uint8_t inputsize, int8_t bytesRead) {
    if (bytesRead == 0) {
    ...
    char *words[3] = {nullptr}; // Array of word pointers
