...
*/
#define DEF_INVX 1  // pan left/right  // 3Dc: 0
#define DEF_INVY 1  // pan up/down     // 3Dc: 1
#define DEF_INVZ 1  // zoom in/out     // 3Dc: 1
#define DEF_INVRX 1 // Rotate around X axis (tilt front/back)  // 3Dc: 0
#define DEF_INVRY 1 // Rotate around Y axis (tilt left/right)  // 3Dc: 1
#define DEF_INVRZ 1 // Rotate around Z axis (twist left/right) // 3Dc: 1
