...
bool SpaceMouseHID_::send_command(int16_t rx, int16_t ry, int16_t rz, int16_t x, int16_t y, int16_t z, SpaceKeys *SMKeys, int debug) {
    ...
    prepareKeyBytes(SMKeys, keyData, debug);       // sort the bytes from keys into the bits in keyData
#endif
...
void SpaceMouseHID_::prepareKeyBytes(SpaceKeys *SMKeys, uint8_t *keyData, int debug) {
