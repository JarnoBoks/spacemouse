...
/**
 * @brief Checks if the provided descriptor matches the Axis' descriptor.
 * @param descriptor The descriptor to compare against the Axis' descriptor.
 * @return True if the descriptors match, false otherwise.
 */
const bool AxisBase::hasDescriptor(const char *descriptor) const {
